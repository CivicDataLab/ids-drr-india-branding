// Prose copy for the /about-us page and related homepage sections.
// Extracted from the host frontend's config/consts.ts so the package
// can ship as a self-contained unit.

export const aboutUsText = 'Get to know IDS-DRR and the team behind it';

export const AboutText = 'About IDS-DRR';
...
export const IntroTextContentThree =
...
export const CollaboratingPartnerTextOne =
...
export const OpenContractingPartnershipTextOne =
...
export const PJMcPartnershipText =
