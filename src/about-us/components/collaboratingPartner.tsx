...
import { CollaboratingPartnerHPText, CollaboratingPartnerTextOne } from "../../consts";
...
export function CollaboratingPartner() {
    ...
    return (
        <section className="flex h-full flex-col flex-wrap py-14 " aria-label="Partners collaborating on this project">
                    ...
                    <div className="flex flex-col items-center gap-4 text-surfaceDefault">
                        ...
                        <div className="flex flex-row items-center justify-between self-stretch">
                            <Button
                                monochrome={true}
                                kind="tertiary"
                                onClick={(event) => handleRedirect(event, "https://asdma.assam.gov.in/")}
                            >
                            ...
                            <Button
                                monochrome={true}
                                kind="tertiary"
                                onClick={(event) => handleRedirect(event, "https://x.com/sdma_assam")}
                            >
                    ...
                    <div className="flex flex-col items-center gap-4 text-surfaceDefault">
                        ...
                        <div className="flex flex-row items-center justify-between self-stretch">
                            <Button
                                monochrome={true}
                                kind="tertiary"
                                onClick={(event) => handleRedirect(event, "https://hpsdma.nic.in/")}
                            >
                            ...
                            <Button
                                monochrome={true}
                                kind="tertiary"
                                onClick={(event) => handleRedirect(event, "https://x.com/hpsdma")}
                            >
